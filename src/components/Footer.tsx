      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-white/60 leading-relaxed">
            Mang đến mâm cơm sạch, an toàn và dinh dưỡng cho người Việt thông qua nông nghiệp tuần hoàn và sản phẩm sinh
            học từ thảo dược thiên nhiên.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm text-white/60">
            <li>
              <Link to="/gioi-thieu" className="hover:text-secondary transition-colors">
                Giới thiệu
              </Link>
            </li>
            <li>
              <Link to="/san-pham" className="hover:text-secondary transition-colors">
                Sản phẩm
              </Link>
            </li>
            <li>
              <Link to="/tin-tuc" className="hover:text-secondary transition-colors">
                Tin tức
              </Link>
            </li>
            <li>
              <Link to="/lien-he" className="hover:text-secondary transition-colors">
                Liên hệ
              </Link>
            </li>
          </ul>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm text-white/60">
            <li>
              <Link to="/san-pham/phan-bon" className="hover:text-secondary transition-colors">
                Phân bón sinh học
              </Link>
            </li>
            <li>
              <Link to="/san-pham/chan-nuoi" className="hover:text-secondary transition-colors">
                Chăn nuôi
              </Link>
            </li>
            <li>
              <Link to="/san-pham/thuy-san" className="hover:text-secondary transition-colors">
                Thủy sản
              </Link>
            </li>
            <li>
              <Link to="/san-pham/bao-quan-thuc-pham" className="hover:text-secondary transition-colors">
                Bảo quản thực phẩm
              </Link>
            </li>
          </ul>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-sm text-white/60">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="tel:0395830009" className="hover:text-secondary transition-colors">
                0395 830 009
              </a>
            </li>
          </ul>
